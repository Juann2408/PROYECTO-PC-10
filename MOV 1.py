...
fichas = {
    "Jugador ROJO":{
        "Ficha 1R":{"posicion":None, "estado": "presa en el extranjero", "Distancia": 0},
        "Ficha 2R":{"posicion":None, "estado": "presa en el extranjero", "Distancia": 0},
        "Ficha 3R":{"posicion":None, "estado": "presa en el extranjero", "Distancia": 0},
        "Ficha 4R":{"posicion":None, "estado": "presa en el extranjero", "Distancia": 0}
    },
    "Jugador AZUL" :{
        "Ficha 1AZ":{"posicion":None, "estado": "presa en el extranjero", "Distancia": 0},
        "Ficha 2AZ":{"posicion":None, "estado": "presa en el extranjero", "Distancia": 0},
        "Ficha 3AZ":{"posicion":None, "estado": "presa en el extranjero", "Distancia": 0},
        "Ficha 4AZ":{"posicion":None, "estado": "presa en el extranjero", "Distancia": 0}
    }
}
